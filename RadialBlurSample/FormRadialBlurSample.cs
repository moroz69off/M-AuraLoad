    ...
    public partial class FormRadialBlurSample : Form
    {
       ...
       protected void ViewOrtho()							// Set Up An Ortho View
        ...
        public void RenderToTexture()							// Renders To A Texture
        {
            ...
            //Установите окно просмотра (сопоставьте размер текстуры)
            gl.Viewport(0,0,128,128);// Set Our Viewport (Match Texture Size)Установите окно просмотра (сопоставьте размер текстуры)
            ...
            //Скопируйте наш ViewPort на текстуру размытия (от 0,0 до 128,128 ... без границ)
